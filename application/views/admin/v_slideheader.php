        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/slide/add_slideheader'?>"><span class="fa fa-plus"></span> Add Photo</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td><img src="<?php echo base_url().'assets/images/header/'.$galeri_gambar;?>" style="width:80px;"></td>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $galeri_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/slide/update_galeri'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $galeri_gambar;?>" name="gambar">
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xjudul" class="form-control" value="<?php echo $galeri_judul;?>" id="inputUserName" placeholder="Judul" readonly>
                                        </div>
                                    </div>

                                    <!-- Switch On/Off Status -->
                                    <div class="form-group">
                                        <label for="statusSwitch" class="col-sm-4 control-label">Status</label>
                                        <div class="col-sm-7">
                                            <input type="checkbox" name="status" id="statusSwitch<?php echo $galeri_id; ?>" <?php echo $galeri_status == 1 ? 'checked' : ''; ?>>
                                        </div>
                                    </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $galeri_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/slide/hapus_slideheader'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $galeri_id;?>"/>
                     <input type="hidden" value="<?php echo $galeri_gambar;?>" name="gambar">
...
<!-- <script>
    ...
    function uploadInChunks(blob) {
        ...
        function uploadNextChunk(start) {
            ...
            $.ajax({
                url: "<?= base_url('admin/slideheader/uploadtoserver') ?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,

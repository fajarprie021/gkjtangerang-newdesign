    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/album'?>"><i class="fa fa-home"></i> Alamat</a></li>
            <li><a href="<?php echo base_url().'admin/galeri'?>"><i class="fa fa-phone"></i> No.Tlp</a></li>
            <li><a href="<?php echo base_url().'admin/galeri'?>"><i class="fa fa-envelope"></i> Email</a></li>
          </ul>
        </li>

            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="xbacaan_alkitab" 
                               ...
                               value="<?php echo htmlspecialchars($b['bacaan_alkitab'] ?? '');?>"
                    ...
                    <div>
                        ...
                        <textarea name="xnats" rows="2" 
                                  ...
                                  placeholder="Contoh: Matius 5:3 - 'Berbahagialah orang yang miskin di hadapan Allah...'"><?php echo htmlspecialchars($b['nats'] ?? '');?></textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="xdoa_pembuka" rows="3" 
                              class="w-full rounded-xl border border-gray-200 bg-gray-50/50 px-5 py-3 outline-none transition focus:border-secondary focus:ring-1 focus:ring-secondary focus:bg-white resize-y font-serif text-gray-700 text-sm leading-relaxed" 
                              placeholder="Tuliskan doa pembuka di sini..."><?php echo htmlspecialchars($b['doa_pembuka'] ?? '');?></textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="xpokok_doa" rows="3" 
                              class="w-full rounded-xl border border-gray-200 bg-gray-50/50 px-5 py-3 outline-none transition focus:border-secondary focus:ring-1 focus:ring-secondary focus:bg-white resize-y font-serif text-gray-700 text-sm leading-relaxed" 
                              placeholder="Tuliskan pokok-pokok doa di sini..."><?php echo htmlspecialchars($b['pokok_doa'] ?? '');?></textarea>
                </div>

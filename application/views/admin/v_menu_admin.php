                ...
                <ul class="sidebar-menu">
                    <?php if ($indexAllMenu->id_halaman == 1): ?>
                        ...
                        <?php if ($query->num_rows() > 0): ?>
                            <li class="treeview">
                                <a href="#"><i
                                        class="<?php echo $indexAllMenu->menu_icon; ?>"></i><?php echo ' ' . $indexAllMenu->menu_name; ?><span></span>
                                    <span class="pull-right-container">
                                ...
                                <ul class="treeview-menu">
                                    <?php foreach ($query->result() as $submenu): ?>
                                        ...
                                        <?php if ($submenu->sub_menu_status == 1): ?>
                                            <li>
                                                <a href="<?php echo site_url('admin/' . $resultReplace_NamePage); ?>">
                                                    <i class="<?php echo $submenu->sub_menu_icon; ?>"></i>
                                                    <?php echo ' ' . $submenu->nama_sub_menu; ?>
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                        ...
                        <?php else: ?>
                            <li><a href="<?php echo base_url('admin/') . $indexAllMenu->menu_href; ?>"><i
                                        class="<?php echo $indexAllMenu->menu_icon; ?>"></i><?php echo ' ' . $indexAllMenu->menu_name; ?></a>
                            </li>
                        <?php endif; ?>
                    <?php else: ?>
                        <li><a href="<?php echo base_url('admin/informasi/halaman/') . $indexAllMenu->menu_href; ?>"><i
                                    class="<?php echo $indexAllMenu->menu_icon; ?>"></i><?php echo ' ' . $indexAllMenu->menu_name; ?></a>
                        </li>
                    <?php endif; ?>
                </ul>

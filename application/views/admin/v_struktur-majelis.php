        ...
        <div class="modal fade" id="ModalHapus<?php echo $tulisan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/strukturmajelis/hapus_strukturmajelis'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $tulisan_id;?>"/>
                     <input type="hidden" value="<?php echo $tulisan_gambar;?>" name="gambar">
...
<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
        <h4 class="modal-title" id="myModalLabel">Add Struktur Majelis</h4>
      </div>
      <form class="form-horizontal" action="<?php echo base_url().'admin/strukturmajelis/simpan_strukturmajelis'?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <label for="inputUserName" class="col-sm-4 control-label">Judul</label>
            <div class="col-sm-7">
...
<script>
    $(document).ready(function() {
        $('.edit-btn').on('click', function() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('admin/strukturmajelis/get_category_name'); ?>',
...
<script>
    $('#editForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url('admin/strukturmajelis/update'); ?>', // Ganti dengan URL update yang sesuai
            type: 'POST',
            data: $(this).serialize(),
            success: function(response) {

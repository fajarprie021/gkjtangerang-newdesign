    ...
    <?php foreach ($menu->result() as $indexAllMenu) :?>
        <ul class="sidebar-menu">
            ...
            <?php if ($query->num_rows() > 0): ?>
                <li class="treeview">
                    <!-- <a href="#"><i class="fa fa-newspaper-o"></i><?php echo $indexAllMenu->menu_name; ?><span></span> -->
                    ...
                    <ul class="treeview-menu">
                        <?php foreach($query->result() as $submenu) { $resultReplace_NamePage = preg_replace("/[^a-zA-Z0-9]/", "", $submenu->sub_menu_href);?>
                            <?php if ($submenu->sub_menu_status == 1): ?>
                                <!-- <li><a href="<?php echo base_url('admin/').$submenu->sub_menu_href;?>"><?php echo $submenu->nama_sub_menu; ?></a></li> -->
                                <!-- <li><a href="<?php echo base_url('admin/').$submenu->sub_menu_href;?>"><i class="<?php echo $submenu->sub_menu_icon;?>"></i><?php echo $submenu->nama_sub_menu; ?></a></li> -->
                                <!-- <li><a href="<?php echo base_url('admin/').$submenu->sub_menu_href;?>"><i class="<?php echo $submenu->sub_menu_icon;?>"></i><?php echo ' '.$submenu->nama_sub_menu; ?></a></li> -->
            ...
            <?php else: ?>
                <!-- <li><a href="<?php echo base_url('admin/').$indexAllMenu->menu_href;?>"><?php echo $indexAllMenu->menu_name; ?></a></li> -->

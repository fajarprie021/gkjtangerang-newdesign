        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" id="uploadForm" action="<?php echo base_url().'admin/galeri/simpan_galeri'?>" method="post" enctype="multipart/form-data">
                                ...
                                <?php endforeach; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <input type="file" class="form-control" name="galeri_gambar" id="fileInput" accept="image/*" required>
                                            <input type="hidden" name="galeri_gambar_resized" id="resizedImageData">
                                        </div>
                                    </div>
...
<!-- <script>
    $(document).ready(function () {
      ...
      // Resize and handle the image file input
          ...
          reader.onload = function (e) {
            ...
            img.onload = function () {
              ...
              canvas.toBlob(function (blob) {
                var resizedImageData = document.getElementById('resizedImageData');
                var reader = new FileReader();
                reader.onloadend = function () {
                  resizedImageData.value = reader.result;
                };
    ...
    if (file) {
        ...
        reader.onload = function(event) {
            ...
            image.onload = function() {
                ...
                document.getElementById('resizedImageData').value = compressedImage;

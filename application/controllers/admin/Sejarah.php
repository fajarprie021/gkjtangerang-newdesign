...
class Sejarah extends CI_Controller{
	...
	function index(){
        ...
        $x['data']=$this->m_tentang->get_all_sejarah();
		$x['datatentang']=$this->m_tentang->get_all_data_sejarah();
		...
		$this->load->view('admin/v_sejarah', compact('x', 'selected_category_id'));
	}
	...
	function get_edit(){
        ...
        $x['data']=$this->m_tentang->get_sejarah_by_kode($kode);
		$x['kat']=$this->m_kategori->get_all_kategori();
		$x['menu']=$this->m_menu->get_all_menu_admin();
		$this->load->view('admin/v_menu_admin',$x);
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
	                        ...
	                        $gambar=$gbr['file_name'];
													...
													$this->m_tentang->simpan_sejarah($judul,$isi,$kategori_id,$kategori_nama,$imgslider,$user_id,$user_nama,$gambar,$slug);
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
	                        ...
	                        $judul=strip_tags($this->input->post('xjudul'));
													...
													$this->m_tentang->update_sejarah($tulisan_id,$judul,$isi,$kategori_id,$kategori_nama,$imgslider,$user_id,$user_nama,$gambar,$slug);
	                    ...
	                    redirect('admin/pengguna');
									...
									$this->m_tentang->update_sejarah_tanpa_img($tulisan_id,$judul,$isi,$kategori_id,$kategori_nama,$imgslider,$user_id,$user_nama,$slug);
									echo $this->session->set_flashdata('msg','info');
									redirect('admin/sejarah');
	            }
	...
	function update() {
		...
		$this->m_tentang->update_data_sejarah($id, $data);
	...
	function hapus_sejarah(){
		...
		$this->m_tentang->hapus_sejarah($kode);

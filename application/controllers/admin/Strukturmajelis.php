<?php
class Strukturmajelis extends CI_Controller{
	...
	function index(){
        ...
        $x['data']=$this->m_tentang->get_all_struktur_majelis();
		$x['datatentang']=$this->m_tentang->get_all_data_struktur_majelis();
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
	                        ...
	                        $gambar=$gbr['file_name'];
													...
													$this->m_tentang->simpan_struktur_majelis($judul,$isi,$kategori_id,$kategori_nama,$imgslider,$user_id,$user_nama,$gambar,$slug);
													echo $this->session->set_flashdata('msg','success');
													redirect('admin/strukturmajelis');
											}else{
	...
	function update_strukturmajelis(){
	...
	function update() {
		...
		$this->m_tentang->update_data_struktur_majelis($id, $data);
	
		echo json_encode(array("status" => TRUE));
	}

	function hapus_strukturmajelis(){
		$kode=$this->input->post('kode');
		$gambar=$this->input->post('gambar');
		$path='./assets/images/'.$gambar;
		unlink($path);
		$this->m_tentang->hapus_struktur_majelis($kode);
